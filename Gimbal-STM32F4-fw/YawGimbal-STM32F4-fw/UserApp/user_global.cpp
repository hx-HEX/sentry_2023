...
void RobotStatesUpdate(void)
{
    ...
    G_sentry.yaw_gimbal_motor[SentryRobot::LEFT_YAW_MOTOR]->m_angle_current = G_sentry.gimbal_imu[SentryRobot::GIMBAL_FIRST_IMU]->m_mahony_filter->m_eular_angle.yaw;
    ...
    G_sentry.yaw_gimbal_motor[SentryRobot::RIGHT_YAW_MOTOR]->m_angle_current = G_sentry.gimbal_imu[SentryRobot::GIMBAL_FIRST_IMU]->m_mahony_filter->m_eular_angle.yaw;
...
void GimbalTargetsUpdate(void)
{
    ...
    if(G_sentry.gimbal_mode == SentryRobot::YAW_GIMBAL_MOVE)
    {
        ...
        {
            G_sentry.yaw_angle_des = G_sentry.gimbal_imu[SentryRobot::GIMBAL_FIRST_IMU]->m_mahony_filter->m_eular_angle.yaw;
