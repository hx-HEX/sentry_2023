...
{
    shoot_motor[LEFT_FRIC_MOTOR] = new M3508(CAN2, LEFT_FRIC_MOTOR_ID,  FRIC_MOTOR_REDUCTION_RATIO);
    ...
    shoot_motor[RIGHT_FRIC_MOTOR] = new M3508(CAN2, RIGHT_FRIC_MOTOR_ID,  FRIC_MOTOR_REDUCTION_RATIO);
    ...
    gimbal_motor[GIMBAL_YAW_MOTOR]->m_angle_td = new Adrc_TD((float)20000, 0.01, 0.01,1);
    gimbal_motor[GIMBAL_YAW_MOTOR]->m_angle_pid = new Pid(50, 0.08, 0, 10, 20000, 20000, 5000, 2000);
    gimbal_motor[GIMBAL_YAW_MOTOR]->m_speed_pid = new Pid(150, 0, 0, 10, 20000, 20000, 5000, 2000);
