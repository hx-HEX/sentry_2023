...
void SentryRobot::InitAllActuators(void)
{
    ...
    yaw_gimbal_motor[LEFT_MOTOR]->m_speed_pid = new Pid(40, 0.00, 0, 10, 10000, 10000, 5000, 2000);
    ...
    yaw_gimbal_motor[RIGHT_MOTOR]->m_speed_pid = new Pid(40, 0.00, 0, 10, 10000, 10000, 5000, 2000);
