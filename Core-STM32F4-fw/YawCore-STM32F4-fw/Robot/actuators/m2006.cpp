 ...
 *               
 */
void M2006::SpeedUpdate(uint8_t type, float input)
{
    if (type == 0) {
 ...
 *                          
 */
void M2006::AngleUpdate(uint8_t type, float input)
{
    if (type == 0) {
 ...
 */
void M2006::EncoderSpeedUpdate(float speed)
{
    m_speed_current_encoder = speed / m_reduction_ratio;
 ...
 */
void M2006::EncoderAngleUpdate(uint32_t value)
{
